...
<div class="site-video">
    <div class="video-wrapper">
        ...
        <video class="bg-video__content" autoplay="" muted="" loop="">
            <source src="{{ asset('front_assets/videos/promo1.mp4')}}" type="video/mp4" />
            <source src="{{ asset('front_assets/videos/promo1.webm')}}" type="video/mp4" />
    ...
    <div class="video-caption">
        <h1 class="bg-text-line">
            Welcome to Funolympics 2023<br />City of Yokyo
        </h1>
        <p class="mt-3">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4">
                <div class="p-3 p-md-5 feature-block-1 mb-5 mb-lg-0 bg bg-sec-1">
                    <div class="text">
                        ...
                        <p>
                            Relive the Yokyo 2023 Games and enjoy the most exciting moments all over again and enjoy with all your friends and family partcipating from virtual as well
                        </p>
                        <p class="mb-0">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="p-3 p-md-5 feature-block-1 mb-5 mb-lg-0 bg bg-sec-2">
                    <div class="text">
                        <h2 class="h5 text-white">City of Yokyo for Funolympics 2023</h2>
                        <p>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="p-3 p-md-5 feature-block-1 mb-5 mb-lg-0 bg bg-sec-3">
                    <div class="text">
                        ...
                        <p>
                            Yokyo hosted four snow events (snowboard big air and freestyle skiing big air, men’s and women’s), plus all the ice events
                        </p>
                        <p class="mb-0">
                            <a href="#" class="btn btn-primary btn-sm px-4 py-2 rounded-0">Read More</a>
                        </p>
            ...
            <div class="item">
                <div class="widget-next-match">
                    ...
                    <div class="text-center widget-vs-contents mb-4">
                        <h4>Volleyball</h4>
                        <p class="mb-5">
                            <span class="d-block">August 15th, 2023</span>
            ...
            <div class="item">
                <div class="widget-next-match">
                    ...
                    <div class="text-center widget-vs-contents mb-4">
                        <h4>Alpine Skiing</h4>
                        <p class="mb-5">
                            <span class="d-block">November 1st, 2023</span>
            ...
            <div class="col-md-4">
                <div class="news-item popular-item set-bg" data-setbg="{{ asset('front_assets/img/gauri.jpg') }}">
                    ...
                    <div class="ni-text">
                        ...
                        <ul>
                            <li><i class="fa fa-calendar"></i> Aug 10, 2023</li>
            ...
            <div class="col-md-4">
                <div class="news-item popular-item set-bg" data-setbg="{{ asset('front_assets/img//cricket.jpg') }}">
                    ...
                    <div class="ni-text">
                        ...
                        <ul>
                            <li><i class="fa fa-calendar"></i> Aug 19, 2023</li>
