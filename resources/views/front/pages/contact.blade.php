        ...
        <div class="row">
            <!-- <div class="col-lg-6">
                <div class="contact__info">
                    <h3>Contact Info</h3>
                    <p>
                        The City of Yokyo won the bid to host the next FunOlympic Games in 2023. During the buildup to the planned games in 2023 the city had already invested hugely in IT infrastructure and
                    ...
                    <ul>
                        ...
                        <li><i class="fa fa-map-marker mr-3"></i> 930 City of Yokyo, Yokyo, Japan</li>
                    </ul>
                </div>
            </div> -->
